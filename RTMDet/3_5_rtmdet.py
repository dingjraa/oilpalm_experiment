...
interval = 10
launcher = 'none'
load_from = '.\\work_dirs\\rtmdet\\fulldata\\three\\backbone\\CSPNeXt\\epoch_293.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    backend_args=None,
    format_only=True,
    outfile_prefix='./outfile_prefix/rtdet',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
work_dir = './work_dirs\\rtmdet/fulldata/three/backbone/CSPNeXt'
