...
interval = 10
launcher = 'none'
load_from = '.\\work_dirs\\rtmdet\\test\\simsppf_GenlanLayer_seg_Bilinear\\epoch_150.pth'
log_level = 'INFO'
...
model = dict(
    ...
    neck=dict(
        ...
        num_csp_blocks=1,
        out_channels=128,
        type='GELAN_UpsamplingBilinear_PAFPN'),
    test_cfg=dict(
        max_per_img=300,
        min_bbox_size=0,
...
test_evaluator = dict(
    ...
    backend_args=None,
    format_only=True,
    outfile_prefix='./outfile_prefix/sim_gen_bilinear',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
work_dir = './work_dirs\\rtmdet/fulldata/test/three/simsppf_GenlanLayer_seg_Bilinear'
