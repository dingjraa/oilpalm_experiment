...
interval = 10
launcher = 'none'
load_from = '.\\work_dirs\\rtmdet\\fulldata\\test\\three\\simsppf_seg\\best_coco_bbox_mAP_epoch_272.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    format_only=True,
    metric='bbox',
    outfile_prefix='./outfile_prefix/simsppf_seg',
    proposal_nums=(
        100,
        1,
        10,
...
work_dir = './work_dirs\\rtmdet/fulldata/test/three/simsppf_seg'
