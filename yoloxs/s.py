...
base_lr = 0.01
custom_hooks = [
    dict(num_last_epochs=3, priority=48, type='YOLOXModeSwitchHook'),
...
interval = 10
launcher = 'none'
load_from = '.\\work_dirs\\singletest\\epoch_284.pth'
log_level = 'INFO'
...
model = dict(
    ...
    neck=dict(
        ...
        use_depthwise=False),
    test_cfg=dict(nms=dict(iou_threshold=0.65, type='nms'), score_thr=0.001),
